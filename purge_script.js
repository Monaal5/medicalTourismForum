...
async function purgeData() {
    try {
        const typesToDelete = ["user", "subreddit", "question", "post", "answer", "comment"]; // subreddit is the community type based on previous files
        ...
        documents.forEach((doc) => {
            // console.log(`Deleting ${doc._type}: ${doc._id}`); // Commented out to reduce noise if many
